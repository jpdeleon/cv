...
*et al.* (incl. **jpdeleon**), 2023, *[A Massive Hot Jupiter Orbiting a
Metal-rich Early M Star Discovered in the TESS Full-frame
...
*et al.* (incl. **jpdeleon**), 2023, *[The mass of TOI-519 b: A close-in
giant planet transiting a metal-rich mid-M
...
*et al.* (incl. **jpdeleon**), 2023, *[A dense mini-Neptune orbiting the
bright young star HD 18599](http://dx.doi.org/10.1093/mnras/stac2845)*,
Monthly Notices of the Royal Astronomical Society, **518**, 2627
...
*et al.* (incl. **jpdeleon**), 2022, *[TOI-2119: a transiting brown
dwarf orbiting an active M-dwarf from NASA’s TESS
...
A.; *et al.* (incl. **jpdeleon**), 2022, *[A Possible Alignment Between
the Orbits of Planetary Systems and their Visual Binary
...
*et al.* (incl. **jpdeleon**), 2022, *[Nodal precession of WASP-33b for
11 yr by Doppler tomographic and transit photometric
...
*et al.* (incl. **jpdeleon**), 2022, *[TOI-2285b: A 1.7 Earth-radius
planet near the habitable zone around a nearby M
...
*et al.* (incl. **jpdeleon**), 2021, *[TOI-2109: An Ultrahot Gas Giant
on a 16 hr Orbit](http://dx.doi.org/10.3847/1538-3881/ac26bd)*, The
Astronomical Journal, **162**, 256
...
Crossfield, Ian J. M.; *et al.* (incl. **jpdeleon**), 2021, *[TESS-Keck
Survey. V. Twin Sub-Neptunes Transiting the Nearby G Star HD
...
*et al.* (incl. **jpdeleon**), 2021, *[Two Bright M Dwarfs Hosting
...
*et al.* (incl. **jpdeleon**), 2021, *[The Magellan-TESS Survey. I.
Survey Description and Midsurvey
...
Castro González, A.; Dı́ez Alonso, E.; Menéndez Blanco, J.; Livingston,
John H.; *et al.* (incl. **jpdeleon**), 2020, *[Planetary candidates
transiting cool dwarf stars from campaigns 12 to 15 of
...
*et al.* (incl. **jpdeleon**), 2020, *[K2-280 b - a low density warm
sub-Saturn around a mildly evolved
...
C.; *et al.* (incl. **jpdeleon**), 2020, *[TOI-503: The First Known
Brown-dwarf Am-star Binary from the TESS
...
*[Three planets transiting the evolved star EPIC 249893012: a hot
8.8-M\<SUB\>$\oplus$\</SUB\> super-Earth and two warm 14.7 and
...
*et al.* (incl. **jpdeleon**), 2020, *[Subaru Near-infrared Imaging
Polarimetry of Misaligned Disks around the SR 24 Hierarchical Triple
...
Néstor; *et al.* (incl. **jpdeleon**), 2020, *[An ultrahot Neptune in
the Neptune desert](http://dx.doi.org/10.1038/s41550-020-1142-z)*,
...
Jenkins, James S.; Dı́az, Matı́as R.; Kurtovic, Nicolás T.; Espinoza,
Néstor; *et al.* (incl. **jpdeleon**), 2020, *[Author Correction: An
ultrahot Neptune in the Neptune
...
Malcolm; *et al.* (incl. **jpdeleon**), 2019, *[Greening of the
brown-dwarf desert. EPIC 212036875b: a 51 M\<SUB\>J\</SUB\> object in a
5-day orbit around an F7 V
...
*et al.* (incl. **jpdeleon**), 2019, *[A Tail Structure Associated with
a Protoplanetary Disk around SU
...
*et al.* (incl. **jpdeleon**), 2019, *[K2-264: a transiting multiplanet
system in the Praesepe open
...
*et al.* (incl. **jpdeleon**), 2019, *[MuSCAT2: four-color simultaneous
camera for the 1.52-m Telescopio Carlos
...
*et al.* (incl. **jpdeleon**), 2018, *[ALMA Reveals a Misaligned Inner
Gas Disk inside the Large Cavity of a Transitional
...
Brewer, Brendon; & **de Leon, Jerome**, 2018, *[DNest4: Diffusive Nested
Sampling in C++ and Python](http://dx.doi.org/10.18637/jss.v086.i07)*,
...
*et al.* (incl. **jpdeleon**), 2018, *[Near-infrared High-resolution
Imaging Polarimetry of FU Ori-type Objects: Toward a Unified Scheme for
...
*et al.* (incl. **jpdeleon**), 2018, *[44 Validated Planets from K2
Campaign 10](http://dx.doi.org/10.3847/1538-3881/aaccde)*, The
...
*et al.* (incl. **jpdeleon**), 2018, *[Subaru/HiCIAO HK \<SUB\>s\</SUB\>
...
Yang, Yi; Hashimoto, Jun; Hayashi, Saeko S.; Tamura, Motohide;
*et al.* (incl. **jpdeleon**), 2017, *[Near-infrared Imaging Polarimetry
of Inner Region of GG Tau A
...
**de Leon, Jerome**, 2016, *[corner.py: Scatterplot matrices in
...
Schölkopf, Bernhard; Hogg, David W.; Wang, Dun; Foreman-Mackey, Daniel;
*et al.*, 2016, *[Modeling confounding by half-sibling
...
Ambikasaran, Sivaram; Foreman-Mackey, Daniel; Greengard, Leslie; Hogg,
David W.; & **de Leon, Jerome**, 2016, *[Fast Direct Methods for
...
**de Leon, Jerome**; Takami, Michihiro; Karr, Jennifer L.; Hashimoto,
Jun; *et al.*, 2015, *[Near-IR High-resolution Imaging Polarimetry of
...
Schölkopf, Bernhard; Hogg, David W.; Wang, Dun; Foreman-Mackey, Daniel;
*et al.*, 2015, Removing systematic errors for exoplanet search via
latent causes, ICML, **37**, 2218
