...
\subsection{About}
\begin{list}{}{\cvlist}
    % \item Research: Published \pubsnumber\ refereed papers with \pubscitations\ total citations and an h-index of \pubshindex, as of \pubsdate\footnote{Publication data collected from \href{https://ui.adsabs.harvard.edu/}{NASA Astrophysics Data System}. Complete listing available on \href{\scholarurl}{Google Scholar}.
    \item \textbf{Research:} Published \pubsnumber\ refereed papers with \pubscitations\ total citations, and an h-index of \pubshindex, as of \pubsdate\footnote{Publication data collected from \href{https://ui.adsabs.harvard.edu/}{NASA Astrophysics Data System}}. Complete listing available on \href{\scholarurl}{Google Scholar}.
